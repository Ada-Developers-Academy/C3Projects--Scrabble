...
describe "Calculating word scores:" do
...
describe "Finding best word score from a list of words:" do
  context "error handling:" do
    ...
    it "ignores invalid words in array_of_words and returns quarter as best word" do
  ...
  context "100% valid lists" do
    it "picks the shortest word for a score when multiple words have the same value" do
      expect(Scrabble::Scrabble.highest_score_from(["apple", "play"])).to eq("play") # "pleaser"
    end

    it "picks the seven-letter word for a score when multiple words have the same value" do
